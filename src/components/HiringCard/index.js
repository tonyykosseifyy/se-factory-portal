...
const HiringCard = ({ id, attributes: {
    ...
    return (
        <div className={`hiring-card-main-container ${(PRE_RELEASE || hiringStatus === HIRED) && "prerelease"}`}
            onMouseOver={(e) => {
                setOpen(true)
        ...
        >
            ...
            <div className={"hiring-card-container"}>
                <div className={"hiring-card-image-container"} style={{ backgroundImage: `url(${coverImage})` }} />
            ...
            <div className={`hiring-card-information-main-container ${open && "open"}`}>
